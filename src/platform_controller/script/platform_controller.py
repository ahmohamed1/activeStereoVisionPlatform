...
class Ui_PlatformController(object):
    def setupUi(self, PlatformController):
        ...
        self.dial_lf.setMinimum(-400)
        self.dial_lf.setMaximum(400)
        ...
        self.left_angle_pub = rospy.Publisher('/left/pan/move', Float64, queue_size=10, latch=True)
        self.right_angle_pub = rospy.Publisher('/right/pan/move', Float64, queue_size=10, latch=True)
